...
function restaurant_recipe_dynamic_editor_styles(){
	...
	if( isset($restaurant_recipe_customizer_all_values['restaurant-recipe-link-color'])){
	...
	if( isset($restaurant_recipe_customizer_all_values['restaurant-recipe-link-hover-color'] )){
